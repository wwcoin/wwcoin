...
static const int64 nStartSubsidy = 1000000000000 * COIN; //trillion
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    */
    if (nHeight == 0) {
        ...
        nSubsidy = nStartSubsidy;//50 trillion premine
    }  else if (nHeight > 50 && nHeight <= 100) {
        nSubsidy = 0;
    }  else if (nHeight > 100 && nHeight <= 250) {
        nSubsidy = 1000 * COIN;
    } else if (nHeight > 250 && nHeight <= 350) {
        nSubsidy = 500 * COIN;
    } else if (nHeight > 350 && nHeight <= 600) {
        nSubsidy = 250 * COIN;
    } else if (nHeight > 600 && nHeight <= 1100) {
        nSubsidy = 150 * COIN;
    } else if (nHeight > 1100 && nHeight <= 2100) {
        nSubsidy = 100 * COIN;
    } else if (nHeight > 2100 && nHeight <= 5100) {
        nSubsidy = 50 * COIN;
    } else {
        nSubsidy = nMinSubsidy;
    }
...
static const int64 nTargetTimespan = 60 * 60; // 1 hour retargeting
static const int64 nTargetSpacing = 60; //1 block per minute
